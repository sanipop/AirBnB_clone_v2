...
class test_inherit_basemodel(unittest.TestCase):
    ...
    def test_instance(self):
        """check status of instance of BaseModel"""
        user = Amenity()
...
class TestAmenity(unittest.TestCase):
    """Amenity class tester function """

    def test_is_subclass(self):
        """Test the basemoddel inheritance"""
        amenity = Amenity()
    ...
    def test_str(self):
        """test the str output of the method"""
        amenity = Amenity()
